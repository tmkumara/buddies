...
import {
  LayoutDashboard, Package, Users, BoxSelect, Layers, Archive, UserCog,
} from "lucide-react";
...
const catalogNav = [
  { label: "Box Designs",  href: "/box-designs",  icon: BoxSelect },
  { label: "Design Types", href: "/design-types", icon: Layers },
